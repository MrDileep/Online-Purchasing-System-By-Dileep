Item=[{"id":111,"Name":"Shirts","Available":20,"Price":550,"Original_Price":300},
       {"id":112,"Name":"Pants","Available":25,"Price":700,"Original_Price":390},
       {"id":113,"Name":"T-Shirts","Available":50,"Price":350,"Original_Price":100},
       {"id":114,"Name":"Blazers","Available":30,"Price":2550,"Original_Price":1400},
       {"id":115,"Name":"Kurtas","Available":21,"Price":900,"Original_Price":400}]
Item1=Item
temp=[]
order=""
...
def removeItem():
    ...
    if len(temp)==d:
        ...
        print(f"{ItemId}'s one available is removed from the list")
    adminDisplayMenu()
def goods():
    Total=0
    print("\n")
